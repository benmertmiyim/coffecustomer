...
class AppTheme {
  ...
  static ThemeData pabloTheme = AppTheme.themeType == ThemeType.light
      ? cookifyLightTheme
      : cookifyDarkTheme;

  static ThemeData pabloLightTheme = createTheme(
  ...
  static resetThemeData() {
    ...
    pabloTheme = AppTheme.themeType == ThemeType.light
        ? pabloLightTheme
        : pabloDarkTheme;
